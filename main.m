...
% scene = 'autoFluorescence2';                % scene name
...
if strcmp(application, 'LiDAR')
    ...
    for frame = 1 : N_c
        ...
        imwrite(d_color_MF{frame}, ['Data\LiDAR\MF_frame', num2str(frame), '.png']);
        imwrite(d_color_CASPI{frame}, ['Data\LiDAR\CASPI_frame', num2str(frame), '.png']);
    end
